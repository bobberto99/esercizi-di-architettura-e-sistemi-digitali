...
HD_PWD='D:/Xilinx/Progetti_Xilinx/10_b_switch_multistadio/10_b_switch_multistadio.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log smart_switch_2_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source smart_switch_2_2.tcl
