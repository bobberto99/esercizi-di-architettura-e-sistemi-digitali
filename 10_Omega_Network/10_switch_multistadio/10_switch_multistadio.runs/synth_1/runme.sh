...
HD_PWD='D:/Xilinx/Progetti_Xilinx/10_switch_multistadio/10_switch_multistadio.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log omega_network_4_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source omega_network_4_4.tcl
