...
HD_PWD='D:/Xilinx/Progetti_Xilinx/10_c_HS_omega_network/10_c_HS_omega_network.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HS_omega_network.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HS_omega_network.tcl
