...
HD_PWD='D:/Xilinx/Progetti_Xilinx/11_Robertson/11_Robertson.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Multiplier_on_board.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Multiplier_on_board.tcl
