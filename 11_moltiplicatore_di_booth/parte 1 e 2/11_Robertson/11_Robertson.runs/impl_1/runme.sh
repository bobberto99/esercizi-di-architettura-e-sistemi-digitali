...
HD_PWD='D:/Xilinx/Progetti_Xilinx/11_Robertson/11_Robertson.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Multiplier_on_board.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Multiplier_on_board.tcl -notrace
