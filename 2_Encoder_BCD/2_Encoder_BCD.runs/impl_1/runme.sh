...
HD_PWD='E:/progetti/2_Encoder_BCD/2_Encoder_BCD/2_Encoder_BCD.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log encoder_con_display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source encoder_con_display.tcl -notrace
