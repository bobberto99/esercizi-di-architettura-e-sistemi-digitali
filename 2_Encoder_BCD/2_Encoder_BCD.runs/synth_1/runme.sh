...
HD_PWD='E:/progetti/2_Encoder_BCD/2_Encoder_BCD/2_Encoder_BCD.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log encoder_con_display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source encoder_con_display.tcl
