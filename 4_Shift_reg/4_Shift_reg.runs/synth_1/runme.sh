...
HD_PWD='D:/Xilinx/Progetti_Xilinx/4_Shift_reg/4_Shift_reg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Shift_reg_struct.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Shift_reg_struct.tcl
