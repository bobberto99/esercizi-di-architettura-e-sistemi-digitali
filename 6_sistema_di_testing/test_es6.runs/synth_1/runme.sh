...
HD_PWD='D:/Xilinx/Progetti_Xilinx/test_es6/test_es6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sistema_testing_on_board.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sistema_testing_on_board.tcl
