...
HD_PWD='D:/Xilinx/Progetti_Xilinx/7_Handshaking/7_Handshaking.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Handshaking_TB.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Handshaking_TB.tcl
