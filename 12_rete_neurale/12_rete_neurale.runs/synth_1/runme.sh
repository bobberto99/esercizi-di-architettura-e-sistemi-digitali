...
HD_PWD='D:/Xilinx/Progetti_Xilinx/12_rete_neurale/12_rete_neurale.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rete_neurale.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rete_neurale.tcl
