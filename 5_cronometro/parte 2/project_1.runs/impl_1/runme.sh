...
HD_PWD='C:/Users/bobbo/Desktop/roba tesina/5_cronometro/parte 2/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cronometro_con_display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cronometro_con_display.tcl -notrace
