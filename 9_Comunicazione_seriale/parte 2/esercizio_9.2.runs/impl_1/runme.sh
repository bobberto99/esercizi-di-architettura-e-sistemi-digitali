...
HD_PWD='C:/Users/bobbo/Desktop/esercizio_9.2/esercizio_9.2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log macchina.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source macchina.tcl -notrace
